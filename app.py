...
st.markdown(
    ...
    <style>
        ...
        [data-testid="stSidebar"] {
            ...
            border-right: 1px solid rgba(74, 20, 140, 0.06);
        }
        ...
        div[data-baseweb="select"]:focus-within > div {
            ...
            box-shadow: 0 0 0 2px rgba(123, 31, 162, 0.1) !important;
        }
        
        [data-testid="stSidebar"] .stAlert {
            background-color: #FAF5FC !important;
            color: #7B1FA2 !important;
            border: 1px solid rgba(123, 31, 162, 0.12) !important;
        ...
        .kpi-container {
            ...
            color: #2A0845;
            text-align: center;
            box-shadow: 0 4px 20px rgba(74, 20, 140, 0.04);
            border: 1px solid rgba(74, 20, 140, 0.02);
        ...
        .kpi-container:hover {
            ...
            box-shadow: 0 12px 30px rgba(74, 20, 140, 0.08);
            border-color: #E1BEE7;
        }
        .kpi-value {
            font-size: 2.2rem;
        ...
        .insight-box {
            ...
            color: #2A0845;
            margin-top: 20px;
            box-shadow: 0 4px 15px rgba(74, 20, 140, 0.02);
            line-height: 1.6;
        }
        ...
        div[data-testid="stDataFrame"] {
            ...
            border: 1px solid rgba(74, 20, 140, 0.04);
        }
    </style>
    """,
